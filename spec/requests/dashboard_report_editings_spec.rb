...
RSpec.describe "Editing a report from the dashboard", type: :request do
  describe "PATCH /api/v1/dashboard/auditions/:audition_id/report" do
    ...
    context "with valid parameters" do
      before do
        ...
        patch "/api/v1/dashboard/auditions/#{audition.id}/report",
          headers: {
